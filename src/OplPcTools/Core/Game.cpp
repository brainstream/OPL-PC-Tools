...
void Game::validateName(const QString & _name, GameInstallationType _installation_type)
{
    switch(_installation_type)
    {
    case GameInstallationType::UlConfig:
        if(_name.toUtf8().size() > max_name_length)
...
void Game::validateId(const QString & _id)
{
...
QString Game::makePartName(const QString & _id, const QString & _name, quint8 _part)
{
...
QString Game::makeIsoFilename(const QString & _title, const QString & _id)
{
